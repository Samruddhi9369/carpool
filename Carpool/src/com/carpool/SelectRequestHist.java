...
public class SelectRequestHist extends Activity
{
	...
	HistoryActivity v=new HistoryActivity();
	//HistoryActivity h=new HistoryActivity();//for flg 
	// Progress Dialog
	...
	JSONParser jsonParser = new JSONParser();
		...
		// single product url
	private static final String url_reqhist_details = "http://192.168.16.1/android_connect/get_reqhist_details.php";
	
		// JSON Node names
	private static final String TAG_SUCCESS = "success";
	private static final String TAG_PRODUCT = "request";
	...
	public void onCreate(Bundle savedInstanceState) 
	{
			...
			setContentView(R.layout.viewreqdetails);
			...
			new GetRequestHistoryDetails().execute();
		 ...
		 * */
		class GetRequestHistoryDetails extends AsyncTask<String, String, String> 
		{
			...
			{
				super.onPreExecute();
				pDialog = new ProgressDialog(SelectRequestHist.this);
				pDialog.setMessage("Loading request history details. Please wait...");
				...
				runOnUiThread(new Runnable()
				{
					public void run() 
					{
						...
						try 
						{
							...
							JSONObject json = jsonParser.makeHttpRequest(url_reqhist_details, "GET", params);
