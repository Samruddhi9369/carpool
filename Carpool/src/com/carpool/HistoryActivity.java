...
public class HistoryActivity extends ListActivity {
	...
	private static String url_request_history = "http://192.168.16.1/android_connect/histrequest.php";
	...
	private static final String TAG_EMAIL1 = "email2";
		...
		// Hashmap for ListView
				...
				lv1.setOnItemClickListener(new OnItemClickListener() 
				{
					...
					public void onItemClick(AdapterView<?> parent, View view,
						...
						// Starting new intent
						Intent in = new Intent(getApplicationContext(),SelectRequestHist.class);
	...
	// Response from Edit Product Activity
		...
		/**
		 * Background Async Task to Load all request by making HTTP Request
		 * */
		class LoadAllRequest extends AsyncTask<String, String, String> {
			...
			protected String doInBackground(String... args) {
				...
				JSONObject json = jParser.makeHttpRequest(url_request_history, "GET", params);
				
				// Check your log cat for JSON reponse
				Log.d("History Requests: ", json.toString());
				...
				try {
					...
					if (success == 1) {
						...
						request = json.getJSONArray(TAG_REQUEST);
